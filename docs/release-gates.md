...
- The rollback/reconnect checks simulate transaction failure and a fresh application instance; an OS-killed process drill remains a stronger optional follow-up, not evidence already collected.

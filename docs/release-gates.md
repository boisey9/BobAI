...
| 2: dependable access | Feature-gated Better Auth passkeys, durable owner sessions/revocation, offline owner bootstrap/recovery command, dependency readiness, bounded provider retries/abort deadline; recovery branch adds encrypted backup/restore and credential limits | Real owner passkeys, project OAuth/PKCE, device grants, legacy retirement, nightly backup activation/key custody, usage/budget controls |

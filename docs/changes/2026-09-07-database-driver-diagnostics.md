...
On September 8 (Toronto), the owner-approved PR #44 merged as `9833e2269a8bbaef399ed6aa0bdd93b94a115b1f`. Core `bob-core-jnhew4l8u-erikboisvert9-5389s-projects.vercel.app` and Web `bob-control-center-erikboisvert9-g997zgllq.vercel.app` are READY on that exact source. Both production alias health endpoints return 200, and a live Codex transactional activity write succeeded. Nightly storage activation remains pending; OAuth remains a feature branch with production flags disabled.

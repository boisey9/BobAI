...
[PR #46](https://github.com/boisey9/BobAI/pull/46) prepares a separately restricted Web database role. Actual provisioning, permission-denial, PostgreSQL/protocol/browser acceptance and all Core/Web CI pass; source review is running. A fresh local encrypted production backup (ten tables) restored in five seconds and passed restored context/task replay/conflict/version acceptance. Upload and dedicated nightly storage credential creation await explicit automatic-review confirmations. See [owner-access preparation](docs/changes/2026-09-08-owner-access-preparation.md).
